...
class Constants(BaseConstants):
    ...
    instructions_template = 'ExSpIntro1/Instructions.html'

    mismatch_payoff = c(0)
    CoordinatePref_payoff = c(10)
    CoordinateNotPref_payoff = c(8)

    Adjmat = ([[False, False, False, False, True, False, True, False, False, False, False, False, False, False, True, False, False, False, False, False],
               [False, False, True, False, False, False, False, True, False, False, False, False, False, False, False, True, False, False, True, True],
               [False, True, False, True, False, False, False, True, False, False, False, False, True, False, False, False, True, False, False, False],
               [False, False, True, False, False, False, False, False, True, False, False, False, False, True, False, False, False, False, True, False],
               [True, False, False, False, False, False, False, False, True, False, False, False, True, False, False, False, False, False, True, True],
               ...
               [False, True, True, False, False, False, False, False, False, False, False, True, False, False, False, True, False, True, False, False],
               [False, False, False, True, True, False, False, False, False, False, False, False, False, False, True, False, True, True, False, False],
               [False, False, False, False, False, False, False, False, False, False, True, False, True, True, False, False, False, False, False, False],
               [False, False, False, False, False, False, False, False, False, True, False, False, False, False, True, True, True, False, False, False],
               [False, False, False, False, False, False, False, True, False, False, False, False, False, False, True, False, False, False, False, False],
               [False, False, True, False, True, False, False, False, False, True, False, False, False, False, False, False, False, False, False, False],
               [False, False, False, True, False, False, False, False, False, True, False, False, False, False, False, True, False, False, True, False],
               [True, False, False, False, False, False, False, False, True, False, True, True, False, False, False, False, False, False, True, False],
               [False, True, False, False, False, True, False, True, False, False, True, False, False, True, False, False, False, True, False, True],
               [False, False, True, False, False, False, False, False, True, False, True, False, False, False, False, False, False, False, False, False],
               [False, False, False, False, False, False, False, True, True, False, False, False, False, False, False, True, False, False, True, False],
               [False, True, False, True, True, False, False, False, False, False, False, False, False, True, True, False, False, True, False, False],
               [False, True, False, False, True, False, True, False, False, False, False, False, False, False, False, True, False, False, False, False]])# to constants?
...
class Subsession(BaseSubsession):
    alpha = [2, 19, 11, 8, 17, 13, 9, 15, 5, 18]
...
class Player(BasePlayer):
    ...
    def ansQues1(self):
        if self.question1 == 10:
            ...
            return 'No es correcto. Si eliges la opción relacionada con tu tipo y el otro jugador elige esta opción también,' \
                   ...
                   'contrario pregunte a uno de los supervisores en la sala para aclarar.'
    ...
    def ansQues2(self):
        if self.question2 == 8:
            ...
            return 'No es correcto. Si eliges la opción que no está relacionada con tu tipo y el otro jugador elige esta' \
                   ...
                   ' es de 8, de lo contrario, pida a uno de los supervisores en la sala para aclarar.'
    ...
    def ansQues4(self):
        if self.question4 == 10:
            ...
            return 'No es correcto. Si eliges la opción relacionada con tu tipo y el otro jugador elige esta opción también, ' \
                   ...
                   ' pida a uno de los supervisores en la sala para aclarar.'
    ...
    def cpay(self):
        ...
        self.participant.vars['pay0'] = self.totpay
        cumulative_payoff = sum([p.ave for p in self.in_all_rounds()])
        return (cumulative_payoff)
    '''
    totpaydis = models.IntegerField()
    def cpaydis(self):
        self.totpaydis = sum([p.ave for p in self.in_all_rounds()])
        self.participant.vars['pay1'] = self.totpaydis
        cumulative_payoffdis = sum([p.ave for p in self.in_all_rounds()])
        return (cumulative_payoffdis)
    '''